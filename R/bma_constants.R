...
kTabAssessmentComposition <- "UW Assessment Composition"
...
column_names_per_sub_tab_selection[[kTabAssessmentComposition]] = list(
  ...
  COLUMN_NAME_FORESTS, COLUMN_NAME_LANDFILL, COLUMN_NAME_AGGREGATE_EXTRACTION)
...
COLUMNS_PERCENT_2_DECIMALS = c(COLUMN_NAME_ANNUAL_POPULATION_INCREASE, COLUMN_NAME_RESIDENTIAL, COLUMN_NAME_MULTI_RESIDENTIAL, COLUMN_NAME_COMMERCIAL, 
                               COLUMN_NAME_INDUSTRIAL, COLUMN_NAME_PIPELINES, COLUMN_NAME_FARMLANDS, COLUMN_NAME_FORESTS, COLUMN_NAME_LANDFILL, COLUMN_NAME_AGGREGATE_EXTRACTION, COLUMN_NAME_TAX_ASSET_CONSUMPTION_RATIO,
