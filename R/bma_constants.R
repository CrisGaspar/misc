...
column_names_per_sub_tab_selection[[SUB_TAB_POPULATION]] = list(
  COLUMN_NAME_POPULATION, COLUMN_NAME_POPULATION_DENSITY, COLUMN_NAME_POPULATION_INCREASE, COLUMN_NAME_BUILDING_CONSTRUCTION_PER_CAPITA,
...
column_names_per_sub_tab_selection[[SUB_TAB_ASSESSMENT_COMPOSITION]] = list(
  ...
  COLUMN_NAME_FORESTS)
column_names_per_sub_tab_selection[[SUB_TAB_BUILDING_PERMIT_ACTIVITY]] = list(COLUMN_NAME_BUILDING_CONSTRUCTION_VALUE, COLUMN_NAME_BUILDING_CONSTRUCTION_PER_CAPITA_WITH_YEAR_PREFIX)
...
column_names_per_sub_tab_selection[[SUB_TAB_NET_EXPENDITURES_PER_CAPITA_MUSEUM]] = list(COLUMN_NAME_MUSEUM) 
