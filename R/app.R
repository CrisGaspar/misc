...
# Columns not in this list will use FORMAT_SETTINGS_CURRENCY_DEFAULT
COLUMN_FORMAT_SETTINGS = list(
  #  COUNTER_DISPLAY_COLUMNS
  COLUMN_NAME_POPULATION = FORMAT_SETTINGS_COUNTER,
  COLUMN_NAME_POPULATION_DENSITY = FORMAT_SETTINGS_COUNTER,
  COLUMN_NAME_LAND_AREA = FORMAT_SETTINGS_COUNTER,
  COLUMN_NAME_TOTAL_INDUSTRIAL_LARGE = FORMAT_SETTINGS_COUNTER,
  
  # CURRENCY_2_DECIMALS_COLUMNS
  COLUMN_NAME_NON_RESIDENTIAL_COMMERCIAL_PER_SQFT = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,
  COLUMN_NAME_NON_RESIDENTIAL_INDUSTRIAL_PER_SQFT = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,
  COLUMN_NAME_TAX_SHOPPING = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,
  COLUMN_NAME_TAX_OFFICE = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,
  COLUMN_NAME_TAX_IND_STANDARD = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,
  COLUMN_NAME_TAX_IND_LARGE = FORMAT_SETTINGS_CURRENCY_2_DECIMALS,

  # PERCENT_1_DECIMAL_DISPLAY_COLUMNS
  COLUMN_NAME_WATER_NET_LIN_LIAB = FORMAT_SETTINGS_PERCENT_1_DECIMAL,
  COLUMN_NAME_WW_NET_LIN_LIAB = FORMAT_SETTINGS_PERCENT_1_DECIMAL,

  # PERCENT_2_DECIMAL_DISPLAY_COLUMNS
  COLUMN_NAME_POPULATION_INCREASE = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_RESIDENTIAL = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_MULTI_RESIDENTIAL = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_COMMERCIAL = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_INDUSTRIAL = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_PIPELINES = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_FARMLANDS = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_FORESTS = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAX_ASSET_CONSUMPTION_RATIO = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAX_DISCRETIONARY_RESERVES_PERCENT_SOURCE_REVENUES = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAX_RESERVES_PERCENT_TAXATION = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAX_DEBT_INT_PERCENT_OSR = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAXR_DEBT_CHARGES_PERCENT_OSR = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_DEBT_TO_RESERVE_RATIO = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TAXES_RECEIVABLE_PERCENT_TAXES_LEVIED = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_RATES_COVERAGE_RATIO = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_NET_FINANCIAL_LIABILITIES_RATIO = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WATER_ASSET_CONSUMPTION = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WW_ASSET_CONSUMPTION = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WATER_RES_PERCENT_OSR = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WW_RES_PERCENT_OSR = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WATER_RES_PERCENT_ACUM_AMORT = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WW_RES_PERCENT_ACUM_AMORT = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WATER_DEBT_INTEREST_COVERAGE = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_WW_DEBT_INTEREST_COVERAGE = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_PROPERTY_TAXES_PERCENT_HOUSEHOLD_INCOME = FORMAT_SETTINGS_PERCENT_2_DECIMALS,
  COLUMN_NAME_TOTAL_MUNICIPAL_BURDEN_PERCENT_HOUSEHOLD_INCOME = FORMAT_SETTINGS_PERCENT_2_DECIMALS,

  # PERCENT_4_DECIMAL_DISPLAY_COLUMNS
  COLUMN_NAME_TAX_RATIOS_MULTI_RESIDENTIAL = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_TAX_RATIOS_COMMERCIAL_RESIDUAL = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_TAX_RATIOS_INDUSTRIAL_RESIDUAL = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_NEW_MULTI_RESIDENTIAL = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_COMMERCIAL_OFFICE = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_COMMERCIAL_SHOPPING = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_COMMERCIAL_PARKING = FORMAT_SETTINGS_PERCENT_4_DECIMALS,
  COLUMN_NAME_INDUSTRIAL_LARGE = FORMAT_SETTINGS_PERCENT_4_DECIMALS,  

  # PERCENT_5_DECIMAL_DISPLAY_COLUMNS
  COLUMN_NAME_TOTAL_RESID = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_MULTI_RESID = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_COMMERCIAL_RESIDUAL = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_COMMERCIAL_OFFICE = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_COMMERCIAL_PARK_VAC = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_COMMERCIAL_SHOPPING = FORMAT_SETTINGS_PERCENT_5_DECIMALS,
  COLUMN_NAME_TOTAL_INDUSTRIAL_RESIDUAL = FORMAT_SETTINGS_PERCENT_5_DECIMALS,

  # PERCENT_6_DECIMAL_DISPLAY_COLUMNS
  COLUMN_NAME_MUNICIPAL_RESID = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_MULTI_RESID = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_COMM_RESIDUAL = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_COMM_OFFICE = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_COMMERCIAL_PARK_VAC = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_COMM_SHOPPING = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_IND_RESIDUAL = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_MUNICIPAL_IND_LARGE = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_RESID = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_MULTI_RESID = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_COMM_RESIDUAL = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_COMM_OFFICE = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_COMMERCIAL_PARK_VAC = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_COMM_SHOPPING = FORMAT_SETTINGS_PERCENT_6_DECIMALS,
  COLUMN_NAME_EDUCATION_IND_LARGE = FORMAT_SETTINGS_PERCENT_6_DECIMALS
)

get_column_format_settings <- function(column_name) {
  if (column_name %in% AS_IS_DISPLAY_COLUMNS) {
    NULL
  }
  else if (column_name %in% COLUMN_FORMAT_SETTINGS) {
    COLUMN_FORMAT_SETTINGS[[column_name]]
  }
  else {
    FORMAT_SETTINGS_CURRENCY_DEFAULT
  }
}
...
function (table, columns, currency = "$", interval = 3, mark = ",", 
          digits = 2, dec.mark = getOption("OutDec"), before = TRUE) 
{
  currency = gsub("'", "\\\\'", currency)
  mark = gsub("'", "\\\\'", mark)
  formatColumns(table, columns, tplCurrency, currency, interval, 
                mark, digits, dec.mark, before)
}

format_columns <- function(data_table) {
  data_table %>% get_column_format_settings
}
