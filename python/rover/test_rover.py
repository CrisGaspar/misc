...
class TestRover(TestCase):
    ...
    def test_check_position(self):
        ...
        position = (0, 0, 'N')
        new_position = (-1, 0, 'N')
        rover = Rover(position, test_id, self.rover_limits)
        ...
        position1 = (3, 4, 'N')
        position2 = (3, 3, 'N')
        rover1 = Rover(position1, test_id, self.rover_limits)
        rover2 = Rover(position2, test_id+1, self.rover_limits)
    ...
    def test_execute(self):
        ...
        rover3 = Rover(position2, test_id+2, self.rover_limits)
        commands3 = "M"
        with self.assertRaises(RoverException):
